...
int main() {
    ...
    int batalha1, batalha2, resultadopop, resultadoarea, resultadopib , resultadotur, resultadodens, resultadopibpc, resultadosuper, enablebatalha;
    int resultado1, resultado2, desempata, resultadofn;
    float atributo1_1, atributo1_2, atributo2_1, atributo2_2, somacarta1, somacarta2;
    ...
    // Escolha o  primeiro atributo do Combate

    printf("Escolha qual o Primeiro atributo que você quer Combater\n");
    ...
    case 2:
       if (pontos_turisticos1 > pontos_turisticos2)
         { printf("A Carta número 1  Maceio venceu o desafio de Pontos Turísticos \n");
            resultado1 = 1 ;
            atributo1_1 = pontos_turisticos1;
            atributo1_2 = pontos_turisticos2;
        } else {
    ...
    // Escolha o  segundo atributo do Combate

    printf("Escolha qual o Segundo atributo que você quer Combater\n");
    printf(" Digite 1 para Combater em População \n");
    printf(" Digite 2 para Combater em Pontos Turísticos \n");
    printf(" Digite 3 para Combater em Área \n");
    printf(" Digite 4 para Combater em PIB \n");
    ...
    // Valida atributos diferentes
    batalha1 != batalha2 ? printf("A Batalha vai Prosseguir \n"): printf("Você Digitou um atributo Repetido \n");
    (batalha1 == batalha2)? : 0;1, enablebatalha ;

    switch (batalha2)

    {
    case 1:
        if (populacao1 > populacao2 && enablebatalha)
         { printf("A Carta número 1  Maceio venceu o desafio de População \n");
            resultado2 = 1 ;
            atributo2_1 = populacao1;
    ...
    case 2:
       if (pontos_turisticos1 > pontos_turisticos2 && enablebatalha)
         { printf("A Carta número 1  Maceio venceu o desafio de Pontos Turísticos \n");
            resultado2 = 1 ;
            atributo2_1 = pontos_turisticos1;
            atributo2_2 = pontos_turisticos2;
        } else {
            printf("A carta número 2 Fortaleza venceu o desafio de Pontos Turísticos \n");
            resultado2 = 0 ;
            atributo2_1 = pontos_turisticos1;
    ...
    case 5:
       if (pibpc1 > pibpc2 && enablebatalha)
         { printf("A Carta número 1  Maceio venceu o desafio de PIB per Capta \n");
            resultado2 = 1 ;
            atributo2_1 = pibpc1;
            atributo2_2 = pibpc2;
    ...
    case 7:
         if (super1 > super2 && enablebatalha)
         { printf("A Carta número 1  Maceio venceu o desafio de Super trunfo! \n");
            resultado2 = 1 ;
            atributo2_1 = super1;
            atributo2_2 = super2;
    ...
    printf("Digite 1 para ver o Resultado final da Batalha \n");

    scanf("%d", &resultadofn);

    if (resultado1 && resultado2 && resultadofn)
    ...
    if (resultado1 != resultado2 && resultadofn) 
    { printf("Houve um empate! Digite 1 para Desempatar \n");
    }
    
    scanf( "%d", &desempata);

    somacarta1 = atributo1_1 + atributo2_1;
    somacarta2 = atributo1_2 + atributo2_2;
    printf(" O Número mágico é da Carta 1 é: %.02f \n", somacarta1);
    printf(" O Número mágico é da Carta 2 é: %.02f \n", somacarta2);

    if (somacarta1 > somacarta2)
        printf("****A Carta 1 Venceu o Desempate*** \n!");
    else if (somacarta2 > somacarta1)
        printf("****A Carta 2 Venceu o Desempate*** \n");
    else printf("O Empate é o Resultado Final \n") ;
